...
class NodeTranslationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetGetNode()
    {
        ...
        $this->assertSame($node, $this->object->getNode());
    }
    ...
    public function testSetGetPublicNodeVersion()
    {
        ...
        $this->assertSame($nodeVersion, $this->object->getPublicNodeVersion());
    }
    ...
    public function testAddGetNodeVersion()
    {
        ...
        $this->assertSame($nodeVersion1, $this->object->getNodeVersion('public'));
        $this->assertSame($nodeVersion2, $this->object->getNodeVersion('draft'));
    }
    ...
    {
        $this->assertSame('Kunstmaan\NodeBundle\Form\NodeTranslationAdminType', $this->object->getDefaultAdminType());
    }
