...
class Events
{
     ...
     * @var string
     */
    const ADD_NODE = 'hgabka_node.addNode';
     ...
     * @var string
     */
    const REVERT = 'hgabka_node.onRevert';
     ...
     * @var string
     */
    const PRE_UNPUBLISH = 'hgabka_node.preUnPublish';
     ...
     * @var string
     */
    const POST_UNPUBLISH = 'hgabka_node.postUnPublish';
     ...
     * @var string
     */
    const PRE_PUBLISH = 'hgabka_node.prePublish';
     ...
     * @var string
     */
    const POST_PUBLISH = 'hgabka_node.postPublish';
     ...
     * @var string
     */
    const PRE_DELETE = 'hgabka_node.preDelete';
     ...
     * @var string
     */
    const POST_DELETE = 'hgabka_node.postDelete';
     ...
     * @var string
     */
    const ADAPT_FORM = 'hgabka_node.adaptForm';
     ...
     * @var string
     */
    const PRE_PERSIST = 'hgabka_node.prePersist';
     ...
     * @var string
     */
    const POST_PERSIST = 'hgabka_node.postPersist';
     ...
     * @var string
     */
    const CREATE_PUBLIC_VERSION = 'hgabka_node.createPublicVersion';
     ...
     * @var string
     */
    const CREATE_DRAFT_VERSION = 'hgabka_node.createDraftVersion';
     ...
     * @var string
     */
    const COPY_PAGE_TRANSLATION = 'hgabka_node.copyPageTranslation';
     ...
     * @var string
     */
    const RECOPY_PAGE_TRANSLATION = 'hgabka_node.recopyPageTranslation';
     ...
     * @var string
     */
    const ADD_EMPTY_PAGE_TRANSLATION = 'hgabka_node.emptyPageTranslation';
     ...
     * @var string
     */
    const CONFIGURE_SUB_ACTION_MENU = 'hgabka_node.configureSubActionMenu';
     ...
     * @var string
     */
    const CONFIGURE_ACTION_MENU = 'hgabka_node.configureActionMenu';
     ...
     * @var string
     */
    const SLUG_SECURITY = 'hgabka_node.slug.security';
     ...
     * @var string
     */
    const PRE_SLUG_ACTION = 'hgabka_node.preSlugAction';
     ...
     * @var string
     */
    const POST_SLUG_ACTION = 'hgabka_node.postSlugAction';
}
